...
export default function Home() {
  return (
    <>
      ...
      <Section>
        <NeonBox animate intensity="high" flicker>
          <div className="text-center">
            <h2 className="text-3xl font-mono font-bold mb-4 text-neon-pink text-shadow-neon-pink">
            ...
            <div className="relative w-full aspect-video max-w-3xl mx-auto mb-6 bg-black p-2 rounded">
              <Image
                src="/assets/foxholeLocation_smaller.png"
                alt="Run Club Meetup"
                fill
            ...
            <h2 className="text-2xl font-mono font-bold mb-2 text-neon-cyan text-shadow-neon-cyan animate-pulse">
              Every Wednesday Run starts at 6:15 PM!
            </h2>
            <h1 className="text-3xl font-mono font-bold mb-4 text-white">
              Last Run of Season: November 6, 2024
            </h1>
            <h2 className="text-xl font-mono mb-8">
